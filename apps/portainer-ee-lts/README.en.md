...
This fixed variant uses **Portainer Business Edition in the LTS channel**.
...
Administrator. You can get the license key via `advanced.license_key`
provide. Details are in [DOCS.md](DOCS.md).
