(() => {
  ...
  // SvelteKit goto() resolves root-relative URLs using the URL constructor.
  window.URL = class extends NativeURL {
    constructor(value, base) { super(typeof value === 'string' && value.startsWith('/') ? rewrite(value, base) : value, base); }
  };
