...
Diese feste Variante verwendet **Portainer Business Edition im STS-Kanal**.
...
Administrator an. STS erhält neue Funktionen früher als LTS. Lizenz-, Speicher-
und Sicherheitsdetails stehen in [DOCS.md](DOCS.md).
