...
This fixed variant uses **Portainer Business Edition in the STS channel**.
It offers Ingress, Docker management, selectable data storage, import/export,
Watchdog and optional user-related ingress sessions. For functions of the
Business Edition requires a valid Portainer license.
...
Administrator. STS receives new features earlier than LTS. license, storage
and security details are in [DOCS.md](DOCS.md).
