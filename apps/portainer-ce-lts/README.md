...
Diese feste Variante verwendet **Portainer Community Edition im LTS-Kanal**.
Sie bietet Home Assistant Ingress, Docker-Verwaltung, wählbaren Datenspeicher,
Import/Export, Watchdog und eine optionale benutzerbezogene Ingress-Sitzung.
...
Administrator an. `advanced.admin_password` ist nur für die erstmalige Anlage
gedacht. Direkte Ports sind für Ingress nicht erforderlich. Details zu
Speicherorten, Backups, Ports und Sicherheit stehen in [DOCS.md](DOCS.md).
