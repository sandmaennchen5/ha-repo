...
The selector uses calendar versions in the form `YYYY.M.N`. Its changelog lists the bundled CE/EE LTS and STS versions and marks an unchanged channel with `keine Änderung`. Fixed-edition apps use `<Portainer upstream version>.<app revision>`, for example `2.39.5.1`.
...
- Programmfunktion: [Upstream-Projekt](https://docs.portainer.io/)
