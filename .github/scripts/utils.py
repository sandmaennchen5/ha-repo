...
def load_config_sections():
    """Load badge and dashboard documents from .github/config.yaml."""
    ...
    badge_data = documents[0] or {} if documents else {}
    dashboard_data = documents[1] or {} if len(documents) > 1 else {}
