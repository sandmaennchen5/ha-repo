...
| `badge_overrides` | object | App-spezifische Badge-Darstellung |
| `group_overrides` | object | App-spezifische Gruppen-Darstellung |
| `upstream_version` | str | Upstream-Version |
| `upstream_repo` | str | GitHub- oder Docker-Hub-Quelle für den Autoupdater |
| `upstream_commit` | str | Git-Commit-Hash oder Docker-Image-Digest |
| `autoupdater` | bool | Beim täglichen App-Updater berücksichtigen |
...
| `source` | str | Quell-Repository und Fallback für `upstream_repo` |
