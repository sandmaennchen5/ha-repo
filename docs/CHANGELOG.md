...
- Automatische Aktualisierung von Apps aus GitHub-Releases und Docker Hub
- Täglicher Lauf um 04:00 UTC und manuelle Auswahl einzelner Apps
- Automatische Aktualisierung von App-Version, Upstream-Metadaten und Changelog
- Expliziter Start des App-Builders nach einem Versionsupdate
- Übersetzungs-Cache für unveränderte Quellen
- No-Key-Übersetzungsfallback über `deep-translator`
- Lint-Konfigurationen unter `.github/.yamllint` und `.github/.hadolint.yaml`

### Dokumentation

- Workflow-, `.var.yaml`-, Troubleshooting- und Dashboard-Dokumentation an den aktuellen Stand angepasst
- Veralteten Strukturentwurf entfernt
- Markdown-Fehler in den Haupt-READMEs korrigiert
